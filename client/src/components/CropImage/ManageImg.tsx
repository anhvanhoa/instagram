...
const ManageImg = ({ listImage, setImages, onChooseImg }: Props) => {
    ...
    return (
        <>
            <TippyHeadLess
                ...
                render={() => (
                    <div className="flex items-center h-32 max-w-sm bg-[#222222]/90 rounded-xl">
                        ...
                        <Button onClick={handleClickInput} text className="p-0 text-white">
            ...
            >
                <div className="">
                    <Button className="text-white cursor-pointer bg-[#222222] hover:bg-[#222]/80 rounded-circle p-2 inline-block px-2">
