const RatioHorizontal = ({ className, color }: { className?: string; color?: string }) => {
    return (
        <svg className={className} color={color} fill={color} height="24" role="img" viewBox="0 0 24 24" width="24">
